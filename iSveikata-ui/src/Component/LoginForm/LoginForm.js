        ...
        <div className="container">
            <section>
                <div className="col-sm-4 col-sm-offset-4 signin-form">
                    {props.loginValueName === "userName" ? <img className="img-responsive" src={system_users} alt="" id="signin-img"/> : <img className="img-responsive" src={patients_login} alt="" id="signin-img"/>}
