                ...
                <form className="form-horizontal" onSubmit={props.submitHandler}>
                    ...
                    <div className="form-group">
                        <div className="form-check col-sm-10 col-sm-offset-2">
                            ...
                            onChange={props.fieldHandler}/>
                            <label className="form-check-label" htmlFor="CheckIfCompensable">Vizitas <strong>{props.isCompensable ? " kompensuojamas " : " nekompensuojamas "}</strong> Valstybinės ligonių kasos.</label>
                        </div>
                        <div className="form-check col-sm-10 col-sm-offset-2">
                            <input type="checkbox" className="form-check-input" id="CheckIfRepetitive" name="isRepetitive" checked={props.isRepetitive} 
                            onChange={props.fieldHandler}/>
                            <label className="form-check-label" htmlFor="CheckIfRepetitive">Vizitas <strong>{props.isRepetitive ? " yra " : " nėra "}</strong> pakartotinis dėl tos pačios priežasties.</label>
                        </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">        
                        <div className="col-sm-offset-2 col-sm-10">
                            <button type="submit" className="btn btn-default" disabled={!props.formValid}>Sukurti įrašą</button>
                        </div>
                    </div>
                </form>
                <Timer />
