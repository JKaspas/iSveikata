        ...
        <form onSubmit={props.submitHandler} className="form-horizontal" >
            <div className="form-group">
                <div className="radio col-sm-9 col-sm-offset-3">
                    <label><input id="userRadioDoctorInput" onChange={props.fieldHandler} type="radio" value="doctor" name="type"/>Gydytojas</label>
                </div>
                <div className="radio col-sm-9 col-sm-offset-3">
                    <label><input id="userRadioAdminInput" onChange={props.fieldHandler} type="radio" value="admin" name="type"/>Administratorius</label>
                </div>
                <div className="radio col-sm-9 col-sm-offset-3">
                    <label><input id="userRadioDruggistInput" onChange={props.fieldHandler} type="radio" value="druggist" name="type"/>Vaistininkas</label>
                </div>
            </div>
            <div className="form-group">
                <label className="control-label col-sm-3">Vardas:</label>
                <div className="col-sm-9">          
                    <input id="userFistNameInput" type="text" className="form-control"  name="firstName"
            ...
            <div className="form-group">
                ...
                <div className="col-sm-9">          
                    <input id="userLastNameInput" type="text" className="form-control"  name="lastName"
            ...
            <div className="form-group">
                ...
                <div className="col-sm-9">          
                    <input id="userUserNameInput" type="text" readOnly className="form-control" name="userName"
            ...
            <div className="form-group">
                ...
                <div className="col-sm-9">          
                    <input id="userPasswordInput" type={props.passwordMasked ? "password" : "text"} readOnly className="form-control" name="password"
            ...
            <div className="form-group">        
                <div className="col-sm-offset-3 col-sm-9">
                    <button id="userFormSubmit" className="btn btn-default" type="submit" disabled={!props.formValid}>Registruoti</button>
                </div>
            </div>
        </form>
    </div>)  
